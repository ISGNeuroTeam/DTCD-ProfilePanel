<template>
  <div class="ProfilePanel">
    ...
    class="Sidebar" >
      ...
      <div class="ProfileOwner">
        ...
        <div class="ProfileOwnerData">
          ...
          <span class="ProfileOwnerRole">Роль: Администратор</span>
        </div>
      </div>
      <div 
      v-bind:class="active" 
    ...
    class="MainContent">
      ...
      class="MyProfile">
        <base-heading class="MainTitle" theme="theme_subheaderSmall"><h1>Мой профиль</h1></base-heading>
      ...
      class="ProfileSettings">
        <base-heading class="MainTitle" theme="theme_subheaderSmall"><h1>Настройки профиля</h1></base-heading>
        <h2 class="Subtitle">Основная информация</h2>
